...
export default function Discount() {
  ...
  return (
    <div className="container mt-5 discount-container">
      <h2 className="mb-4 text-primary fw-bold">Quản lý mã Booking</h2>
      ...
      <div className="row mb-4 align-items-center">
        ...
        <div className="col-md-6 text-md-end mt-3 mt-md-0">
          <button className="btn btn-primary btn-add shadow-sm">
            <i className="fas fa-plus me-2"></i> Thêm booking (ai làm chức năng này thì suy nghĩ nút cho cái này nhé)
          </button>
        </div>
      </div>
