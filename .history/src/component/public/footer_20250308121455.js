            ...
            >
                <div className="row">
                    <div className="col-lg-3 col-md-6 mb-4">
                        ...
                        <h6
                            className="text-white text-uppercase mt-3 mb-2"
                    ...
                    <div className="col-lg-3 col-md-6 mb-4">
                        ...
                        <div className="d-flex justify-content-start">
                            <a
                                className="btn btn-square mr-2"
                                href="#"
                                style={{ backgroundColor: "#1A3C73", color: "#fff" }}
                            >
                            ...
                            <a
                                className="btn btn-square mr-2"
                                href="#"
                                style={{ backgroundColor: "#FF5F00", color: "#fff" }}
                            >
                            ...
                            <a
                                className="btn btn-square"
                                href="#"
                                style={{ backgroundColor: "#D71E18", color: "#fff" }}
                            >
