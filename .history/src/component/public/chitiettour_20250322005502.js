...
const TourInfo = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:8080/tour/getmaxmin?id=${id}`).then(data => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8080/tour/getinfortour?id=${id}&idnv=${o}`)
      .then(data => {
        sett(data.data.data);
      });
  }, []);
  ...
  return (
    <>
      <div className="container mt-4">
        ...
        <div className="row mt-4">
          ...
          <div className="col-md-6">
            ...
            <button
              ...
              className="w-100"
              style={{
                backgroundColor: chuachon == true ? '#7AB730' : 'gray',
                color: 'white',
        ...
        <h2 class="mb-3">Có thể bạn sẽ thích</h2>
        <Slider ds={favorite} />
        <hr></hr>
