...
<div class="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5" style={{marginTop:"90px"}}>
    ...
    <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style={{borderColorolor: "rgba(256, 256, 256, .1) " }}>
        <div class="row">
            <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white-50">Copyright &copy;  . All Rights Reserved. 
                </p>
            </div>
