              ...
              <Card className="border-0 shadow rounded-3 mb-4">
                <Card.Body className="text-center">
                  <div className="d-flex justify-content-center align-items-center my-2 position-relative">
                    ...
                    >
                      {/* Sử dụng Bootstrap Icons thay vì Font Awesome */}
                      <i className="bi bi-telephone-fill h4" style={{ color: "#00A3FF" }}></i>
                    </div>
                  </div>
                ...
                <Card.Body className="text-center">
                  <div className="d-flex justify-content-center align-items-center my-2 position-relative">
                    ...
                    >
                      ...
                      <i className="bi bi-envelope-fill h4" style={{ color: "#FF6F61" }}></i>
                    </div>
                  </div>
                  <div style={{ marginTop: "30px" }}>
              ...
              <Card className="border-0 shadow rounded-3 mb-4">
                <Card.Body className="text-center">
                  <div className="d-flex justify-content-center align-items-center my-2 position-relative">
                    ...
                    >
                      {/* Sử dụng Bootstrap Icons */}
                      <i className="bi bi-globe h4" style={{ color: "#FFB300" }}></i>
                    </div>
                  </div>
                  <div style={{ marginTop: "30px" }}>
                      ...
                      <ListGroup horizontal className="justify-content-center">
                        <ListGroup.Item className="border-0">
                          <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">
                            <i className="bi bi-youtube h4" style={{ color: "#FF0000" }}></i>
                          </a>
                        </ListGroup.Item>
                        <ListGroup.Item className="border-0">
                          <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
                            <i className="bi bi-instagram h4" style={{ color: "#E1306C" }}></i>
                          </a>
                        </ListGroup.Item>
                        <ListGroup.Item className="border-0">
                          <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer">
                            <i className="bi bi-twitter h4" style={{ color: "#1DA1F2" }}></i>
                          </a>
                        </ListGroup.Item>
                        <ListGroup.Item className="border-0">
                          <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                            <i className="bi bi-facebook h4" style={{ color: "#3B5998" }}></i>
                          </a>
                        </ListGroup.Item>
                        <ListGroup.Item className="border-0">
                          <a href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer">
                            <i className="bi bi-tiktok h4" style={{ color: "#00F2EA" }}></i>
                          </a>
                        </ListGroup.Item>
                        <ListGroup.Item className="border-0">
                          <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer">
                            <i className="bi bi-linkedin h4" style={{ color: "#0077B5" }}></i>
                          </a>
                        </ListGroup.Item>
                        <ListGroup.Item className="border-0">
                          <a href="https://www.pinterest.com" target="_blank" rel="noopener noreferrer">
                            <i className="bi bi-pinterest h4" style={{ color: "#E60023" }}></i>
                          </a>
                        </ListGroup.Item>
                      </ListGroup>
                    </div>
