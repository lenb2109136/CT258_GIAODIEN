          ...
          <Row className="py-5">
              ...
              <Card className="border-0 shadow rounded-3 mb-4">
                <Card.Body className="text-center">
                  <div className="d-flex justify-content-center align-item-search my-2">
                    <div className="bg-info rounded-circle shadow-sm bg-opacity-10 p-3 mb-2">
                      <img src={call} alt="Gọi" className="img-fluid" style={{ width: "40px", height: "40px" }} />
                    </div>
                  </div>
            ...
            <Col lg="4" md="6" className="mb-4 mb-lg-0">
              <Card className="border-0 shadow rounded-3 mb-4">
                <Card.Body className="text-center">
                  <div className="d-flex justify-content-center align-item-search my-2">
                    <div className="bg-danger rounded-circle shadow-sm bg-opacity-10 p-3 mb-2">
                      <img src={email} alt="Email" className="img-fluid" style={{ width: "40px", height: "40px" }} />
                    </div>
                  </div>
            ...
            <Col lg="4" md="12" className="mb-4 mb-lg-0">
              <Card className="border-0 shadow rounded-3 mb-4">
                <Card.Body className="text-center">
                  <div className="d-flex justify-content-center align-item-search my-2">
                    <div className="bg-warning rounded-circle shadow-sm bg-opacity-10 p-3 mb-2">
                      <img src={social} alt="Mạng xã hội" className="img-fluid" style={{ width: "40px", height: "40px" }} />
                    </div>
                  </div>
