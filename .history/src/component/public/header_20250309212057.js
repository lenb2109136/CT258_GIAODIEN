                    ...
                    <nav className="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                        ...
                        <div className="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                            <div className="navbar-nav ml-auto py-0">
                                <a onClick={() => navigate("/khachhang/home")} style={{ cursor: "pointer" }} className="nav-item nav-link">
                                    Trang Chủ
                                </a>
                                <a onClick={() => navigate("/khachhang/about")} style={{ cursor: "pointer" }} className="nav-item nav-link">
                                    Giới Thiệu
                                </a>
                                <a onClick={() => navigate("/khachhang/listtour")} style={{ cursor: "pointer" }} className="nav-item nav-link">
                                    Dịch Vụ
                                </a>
                                <a href="package.html" className="nav-item nav-link">
                                    Gói Du Lịch
                                </a>
                                <a onClick={() => navigate("/khachhang/contact")} style={{ cursor: "pointer" }} className="nav-item nav-link">
                                    Liên Hệ
                                </a>
                            </div>
                        </div>
