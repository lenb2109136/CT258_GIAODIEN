      ...
      <ul className="list-unstyled">
        ...
        <li className="sidebar-item">
          <span
            ...
            className={`sidebar-link ${location.pathname === '/admin/tour' ? 'active' : ''}`}
          >
        ...
        <li className="sidebar-item">
          <span
            ...
            className={`sidebar-link ${location.pathname === '/admin/booking' ? 'active' : ''}`}
          >
        ...
        <li className="sidebar-item">
          <span
            ...
            className={`sidebar-link ${location.pathname === '/admin/discount' ? 'active' : ''}`}
          >
        ...
        <li className="sidebar-item">
          <span
            ...
            className={`sidebar-link ${location.pathname === '/admin/category' ? 'active' : ''}`}
          >
        ...
        <li className="sidebar-item">
          <span
            ...
            className={`sidebar-link ${location.pathname === '/admin/user' ? 'active' : ''}`}
          >
