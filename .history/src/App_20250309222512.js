...
import Admin from "./component/public/admin/Admin"; // Thêm import cho trang admin
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/admin/account-management" element={<Admin />} /> {/* Sử dụng cùng component Admin cho quản lý tài khoản */}
