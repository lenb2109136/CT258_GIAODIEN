...
import Login from "./component/public/login/Login"; // Import Login component
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/signup" element={<Login initialTab="register" />} /> {/* Route cho Đăng Ký */}
        <Route path="/register" element={<Login initialTab="register" />} /> {/* Route thay thế nếu cần */}
